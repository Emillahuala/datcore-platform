...
import { LayoutDashboard, FolderKanban, HelpCircle, LogOut } from 'lucide-react'
import { createClient } from '@/lib/supabase/client'
import type { AppUser } from '@/types/user'

const NAV_ITEMS = [
  { href: '/ejecutivo',          icon: LayoutDashboard, label: 'Mi Panel',     active: true  },
  { href: '/ejecutivo/proyectos',icon: FolderKanban,    label: 'Mis Proyectos',active: false },
  { href: '/ejecutivo/ayuda',    icon: HelpCircle,      label: 'Ayuda',        active: false },
]

export function EjecutivoSidebar({ user }: { user: AppUser }) {
      ...
      <div className="px-2 mb-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[0.6rem] text-white/40 uppercase tracking-wider">Ejecutivo</p>
          </div>
        </div>
      </div>
